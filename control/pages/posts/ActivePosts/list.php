...
<?php if(count($result)<1):?>
    <div class="card">
        <p><b>Hal-hazırda aktiv paylaşım yoxdur.</b></p>
    </div>
<?php endif;?>    
...
<div class="card" >
    ...
    <?php endif;?>
            ...
            <div class="buttons">
            <a href="http://localhost/social%20M//control/pages/posts/PostOptions/accept.php?deletePost_id=<?=$data["post_id"]?>" class='btn btn-dark' style="color:white">Paylaşımı sil</a>
            <a href="http://localhost/social%20M//control/pages/posts/PostOptions/accept.php?block_id=<?=$data["post_id"]?>" class='btn btn-danger' style="color:white">Paylaşımı blokla</a>
